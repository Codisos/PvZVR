...
namespace Sisus.ComponentNames
{
	...
	public static class ComponentExtensions
	{
		...
		{
			#if UNITY_EDITOR
			ComponentName.Set(component, name, ModifyOptions.Defaults);
			#endif
		}
		...
		{
			#if UNITY_EDITOR
			ComponentName.Set(component, name, classNameSuffix, ModifyOptions.Defaults);
			#endif
		}
		...
		{
			#if UNITY_EDITOR
			ComponentName.Set(component, name, suffix, ModifyOptions.Defaults);
			#endif
		}
